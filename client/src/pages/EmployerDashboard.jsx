...
const EmployerDashboard = () => {
  ...
  return (
    <div className="p-6">
        ...
        <div>
          ...
          {employerInfo && (
            <p className="text-sm text-gray-600 mt-1">
              Logged in as <strong>{employerInfo.employerUsername}</strong> from{" "}
              <strong>{employerInfo.companyName}</strong> (
      ...
      {/* Approvals, Market Ads, Requests, etc. — keep all your original JSX below */}
      {/* If you want me to include those too, let me know and I’ll paste the full version */}
    </div>
  );
};
